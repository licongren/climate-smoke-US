...
if (final_train){
 ...
 final_models <- list(lasso_region = lasso_region, 
                      lasso_eco2 = lasso_eco2, 
                      lasso_eco3 = lasso_eco3,
                      lasso_grid = lasso_grid)
 
saveRDS(final_models, file = paste0(output_path, "/",region_label,"_",MODEL,"_log_weighted_final_models.rds"))
}
}
